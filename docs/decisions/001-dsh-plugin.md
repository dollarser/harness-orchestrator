> 历史决定：0.6.0 已由 [ADR 003](003-multi-agent-setup.md) 取代；下文仅记录旧实现。

# ADR-001：用 DSH 原生插件落实路线 A

- 日期：2026-09-16
- 状态：DSH 原生插件路线保留；固定流程策略由 [ADR-002](002-agent-owned-execution.md) 替代

以下为 0.3.x 历史决策。当前执行方式见 ADR-002。
